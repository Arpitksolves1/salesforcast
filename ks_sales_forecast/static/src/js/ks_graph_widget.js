...
const { useEffect, useRef, xml, onWillUpdateProps,onMounted,onWillStart,Component} = owl;
  ...
  setup() {
        super.setup();
        const self = this;
         loadJS('ks_sales_forecast/static/lib/js/Chart.js');
//         loadJS('ks_sales_forecast/static/src/js/ks_action_manager_report.js');
//         loadJS('ks_sales_forecast/static/src/js/ks_graph_widget.js');
//         loadCSS('ks_sales_forecast/static/src/css/ks_graph_view.css') ;
...
//        }
   ...
   registry.category("fields").add('ks_graph', KsGraphViewOwl);
